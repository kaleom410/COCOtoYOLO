...
# configurations
required_categories = {5: 'traffic light'}

annFile = 'O:\downloads\stuff_annotations_trainval2017\stuff_train2017.json'
...
catNms = [category for category in 'traffic light']
...
for img in images:
    ...
    ###### uncomment this when failure occurs #######
     # if '000000391895.jpg' == img['file_name']:
     #     quit()
    ####### till here #######
    ...
    with open(filename, 'wb') as handler:
        ...
        with open(folder_name + "/annotations_v" + str(counter // folder_img_count) + '.csv', "a+") as myfile:
            for i in range(len(anns)):
                ...
                mystring = img['file_name'] + ',' + required_categories[anns[i]['category_id']] + ',' + str(xmin) + ',' + str(ymin) + ',' + str(xmax) + "," + str(ymax)
